...
\\
\>[B]{}\Varid{depth}\;\Conid{Leaf}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{depth}\;\Conid{Fork}\;(\Varid{t1},\Varid{t2})\mathrel{=}\Varid{abs}\;(\Varid{succ}\;(\Varid{depth}\;\Varid{t1})\mathbin{-}\Varid{succ}\;(\Varid{depth}\;\Varid{t2})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{balance}\mathbin{::}\Conid{LTree}\;\Varid{a}\to \Conid{LTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{balance}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{hyloSList}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaTLTree}\;\Varid{f}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{hyloTLTree}\;\Varid{a}\;\Varid{c}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{tipsTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{depthTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{geraSierp}\mathbin{::}\Conid{Tri}\to \Conid{Int}\to \mathsf{TLTree}\;\Conid{Tri}{}\<[E]%
\\
\>[B]{}\Varid{geraSierp}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{countTLTree}\mathbin{::}\mathsf{TLTree}\;\Varid{b}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{countTLTree}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{parBTreeMap}\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
